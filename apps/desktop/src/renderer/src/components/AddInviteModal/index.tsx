...
export default function AddInviteModal({ onSubmit, onClose, error: externalError }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!nick) { setError('Nickname is required.'); return; }
    setSubmitting(true);
    setError('');
    try {
      await onSubmit(nick);
  ...
  return (
    <div className="create-modal-backdrop" onClick={onClose} role="presentation">
      <div className="create-modal panel" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true">
        ...
        <p className="muted-text" style={{ marginBottom: '1rem', fontStyle: 'normal', fontSize: '0.85rem' }}>
        ...
        <form onSubmit={(e) => void handleSubmit(e)} className="create-modal-form">
          ...
          <div className="create-modal-actions">
            ...
            <button type="submit" className="primary" disabled={submitting || !nickname.trim()}>
